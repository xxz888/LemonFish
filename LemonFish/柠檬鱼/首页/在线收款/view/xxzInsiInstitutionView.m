...
@implementation xxzInsiInstitutionView
...
- (IBAction)recordAction:(id)sender {
    ...
    [self.viewController.xp_rootNavigationController pushViewController:[xxzAreaOprationController new] animated:YES];
}
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        self = [[[NSBundle mainBundle] loadNibNamed:@"xxzInsiInstitutionView" owner:nil options:nil] firstObject];
    }
    return self;
}
